...
{
    public interface IORMLogService : IService<ORMLog>
    {
       
        void AlterStatus(List<long> ids);
    }
    public class ORMLogService : Service<ORMLog>, IORMLogService
    {
        private readonly IRepositoryAsync<ORMLog> _repository;
        public ORMLogService(IRepositoryAsync<ORMLog> repository) : base(repository)
        {
