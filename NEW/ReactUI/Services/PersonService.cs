...
using System.Linq;
using ReactUI.Infrastructure;
using ReactUI.Models;

namespace ReactUI.Services
{
    public class PersonService : ServiceBase
    {
        ...
        public virtual Result Update(PersonModel model)
        {
            ...
            var person = PeopleList.FirstOrDefault(x => x.Id == model.Id);
            if (person == null)
        ...
        {
            var unit = PeopleList.FirstOrDefault(x => x.Id == id);
            if (unit == null)
