...
namespace Tenant.Models
{
    public class TenantMaster
    {
        public TenantMaster()
        {
            ...
            Applications=new List<TenantApplicationMapping>();
        }
        [Key]
        ...
        [Required, MinLength(20, ErrorMessage = "Oppsss..It looks like you have entred wrong address.Please correct it."), MaxLength(200)]
        ...
        public virtual ICollection<TenantApplicationMapping> Applications { get; set; }
    ...
    public class Application
    {
        public Application()
        {
            ...
            Tenants=new List<TenantApplicationMapping>();
        }
        [Key]
        public string Id { get; set; }
        ...
        public bool IsActive { get; set; }
        public virtual List<TenantApplicationMapping> Tenants { get; set; } 
