...
namespace EntityFramework.BulkInsert.Extensions
{
    public static class BulkInsertExtension
    {
        ...
        */
        ...
        public static void BulkInsertNew<T>(this DbContext context, IEnumerable<T> entities, BulkInsertOptions options,string connectionString="")
        {
            var bulkInsert = new EfSqlBulkInsertProviderWithMappedDataReader(connectionString) {Options = options};
            bulkInsert.SetContext(context);
            bulkInsert.Run(entities);
        }
    ...
    public static class BulkInsertDefaults
    {
        ...
        public static SqlBulkCopyOptions SqlBulkCopyOptions = SqlBulkCopyOptions.CheckConstraints| SqlBulkCopyOptions.Default;
