...
namespace TrackoAPI.WebUtilities
{
    ...
    /// make sure to register the <see cref="TrackoAPI.WebUtilities.UnityPerRequestHttpModule"/> with the web application.
    ...
    public class PerRequestLifetimeManager : LifetimeManager
    {
        ...
        {
            if (this.GetValue() is IDisposable disposable)
            {
                disposable.Dispose();
            }
