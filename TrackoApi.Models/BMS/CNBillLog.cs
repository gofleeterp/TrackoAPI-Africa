...
{
    [Table("tCNBillLog")]
    public class CNBillLog : AuditableEntity
    {
        [Column("BillId"), Index("IDX_CNBillLog_UniqueKey", IsUnique = true,Order = 0)]
        public long BillId { get; set; }
        [ForeignKey("BillId")]
        public virtual CNBill fk_Bill { get; set; }
        [Column("TripLogId"), Index("IDX_CNBillLog_UniqueKey", IsUnique = true, Order = 2)]
        public long? TripLogId { get; set; }
        [ForeignKey("TripLogId")]
        public virtual VehicleMovementLog fk_TripLog { get; set; }
        [Column("CNId"), Index("IDX_CNBillLog_UniqueKey", IsUnique = true, Order = 1)]
        ...
        public virtual SalesLog fk_SalesLog { get; set; }
        /// <summary>
        /// ContantId 
        /// </summary>
        [Column("ParticularId"), Index("IDX_CNBillLog_UniqueKey", IsUnique = true, Order = 3)]
