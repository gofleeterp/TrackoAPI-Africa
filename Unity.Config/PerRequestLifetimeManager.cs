...
namespace Unity.Config
{
    ...
    /// <remarks>
    /// <para>
    /// Although the <see cref="PerWebAPIRequestLifetimeManager"/> lifetime manager works correctly and can help
    ...
    /// make sure to register the <see cref="UnityPerWebAPIRequestHttpModule"/> with the web application.
    /// To do this, invoke the following in the Unity bootstrapping class (typically UnityMvcActivator.cs):
    /// <code>DynamicModuleUtility.RegisterModule(typeof(UnityPerWebAPIRequestHttpModule));</code>
    /// </para>
    /// </remarks>
    public class PerWebAPIRequestLifetimeManager : LifetimeManager,
                                             ...
                                             ITypeLifetimeManager
    {
        ...
        {
            return UnityPerWebAPIRequestHttpModule.GetValue(_lifetimeKey)??NoValue;
        }
        ...
        {
            UnityPerWebAPIRequestHttpModule.SetValue(_lifetimeKey, newValue);
        }
        ...
        public override void RemoveValue(ILifetimeContainer container = null)
        {
            ...
            UnityPerWebAPIRequestHttpModule.SetValue(_lifetimeKey, null);
        }
        ...
        {
            return new PerWebAPIRequestLifetimeManager();
        }
    }
}
