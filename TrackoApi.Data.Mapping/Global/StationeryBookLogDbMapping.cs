...
{
    public class StationeryBookLogDbMapping : EntityTypeConfiguration<StationeryBookLog>
    {
        public StationeryBookLogDbMapping()
        {
            ...
            HasRequired(x => x.fk_StationeryBook).WithMany().HasForeignKey(x => x.BookId).WillCascadeOnDelete(false);
            Property(x => x.AllotedDate).IsRequired();
        }
    }
