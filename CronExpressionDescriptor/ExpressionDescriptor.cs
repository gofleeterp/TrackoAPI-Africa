...
namespace CronExpressionDescriptor
{
  ...
  public class ExpressionDescriptor
  {
    ...
    public ExpressionDescriptor(string expression, Options options)
    {
      ...
      m_use24HourTimeFormat = m_options.Use24HourTimeFormat != null ? m_options.Use24HourTimeFormat.Value : m_24hourTimeFormatTwoLetterISOLanguageName.Contains(m_culture.TwoLetterISOLanguageName);
    }
